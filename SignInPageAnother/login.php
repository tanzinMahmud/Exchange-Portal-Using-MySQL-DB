<?php
	setcookie("message","Welcome",time()+5000);
?>
<!DOCTYPE html>
<html>
<head>
...
<p align="center" style="color:red">You must login first to post ad</p>
<h3 style="color:#00bfff" align="center">Log in</h3>
<table align="center" style="border:none; border-radius:30px">
<tr>
<td align="center">
<form action="logincheck.php" method="post" name="submitsignin">
<h4 style="">
...
<input type="submit" class="oto_button" value="login" name="submitsignin"/>
<hr>
</h4>
