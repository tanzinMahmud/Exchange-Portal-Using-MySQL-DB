	...
	<body>
		...
		<div>
			...
			require("db.php");
				...
				<b><p align="center">All posted ads:</p></b>
				<form align="center" action="show_my_ad.php" method="post">
				<input type="text" name="se_no" placeholder="Enter serial no to delete ad" id="sl" style="width:215px; height:25px"><br><br>
						  <button class="oto_button" onclick="return check()">Delete</button></form><br><?php
				foreach($jd as $v){
					?>
					<form align="center" action=""><br>
					<img style="height:130px; width:130px"src="/ProjectV1.3/AfterSignInPage/<?php echo $v["product_picture"]?>"><br>
					<b>Serial no: 
					...
					<?php 
						  ...
						  echo $v["ex_product_name"];?></br>Additional money: <?php
						  echo $v["additional_money"]."TK";?></br>Post time: <?php
						  echo $v["posted_time"];?></br>Post date: <?php
						  echo $v["posted_date"];?></br>Posted by: <?php
						  echo $v["customer_id"];?></br>Address: <?php
						  echo $v["area"];?></br>Contact no: <?php
						  echo $v["phone_no"];
						  ?>
