	...
	<body>
		...
		<div>
			...
			require("db.php");
				...
				<b><p align="center">All customers:</p></b>
				<form align="center" action="all_cus_delete.php" method="post">
				<input type="text" name="se_no" placeholder="Enter serial no to delete customer" id="sl" style="width:215px; height:25px"><br><br>
				...
				foreach($jd as $v){
					...
					<?php 
						  echo $v["customer_id"];?></b></br>Name: <?php
						  echo $v["first_name"];?></b></br>Email: <?php
						  echo $v["email"];?></br>
